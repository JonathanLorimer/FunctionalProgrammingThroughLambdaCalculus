...
/* package LambdaCalculus-0.1.0.0 */
#ifndef VERSION_LambdaCalculus
#define VERSION_LambdaCalculus "0.1.0.0"
#endif /* VERSION_LambdaCalculus */
#ifndef MIN_VERSION_LambdaCalculus
#define MIN_VERSION_LambdaCalculus(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_LambdaCalculus */
...
#define CURRENT_PACKAGE_KEY "LambdaCalculus-0.1.0.0-inplace-FunctionalProgrammingThroughLambdaCalculus"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "LambdaCalculus-0.1.0.0-inplace-FunctionalProgrammingThroughLambdaCalculus"
